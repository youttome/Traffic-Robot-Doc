...
QVariant DataManager::defaultDataFor(const QString &filename) const
{
    ...
    if (filename == "robot_telemetry.json") {
        return QVariantMap{
            ...
            {"lon", 32.30487},
            {"zoom", 16},
            {"missionTime", "02:14:33"},
            {"routeState", "Crossing Sector B2"},
            {"autonomyMode", "AUTO NAV"},
            {"targetZone", "Sector B2 / Gate 3"},
            {"speedKph", 12.4},
            {"headingDeg", 68},
            {"headingLabel", "ENE"},
            {"etaSeconds", 95},
            ...
            {"trail", QVariantList{
                QVariantMap{{"lat", 30.60172}, {"lon", 32.30091}},
                QVariantMap{{"lat", 30.60204}, {"lon", 32.30198}},
                QVariantMap{{"lat", 30.60231}, {"lon", 32.30288}},
                QVariantMap{{"lat", 30.60258}, {"lon", 32.30391}},
                QVariantMap{{"lat", 30.60291}, {"lon", 32.30487}},
            }},
            {"lastUpdated", QDateTime::currentSecsSinceEpoch()},
        };
    }
